#2. Design automation script which accept directory name and write names 
# of duplicate files from that directory into log file named as Log.txt. Log.txt 
...
def duplicate_file_tracker(directory_name):
    ret = False
...
def main():
    ...
    if len(sys.argv) == 2:
        ...
        duplicate_file_tracker(directory_name)
